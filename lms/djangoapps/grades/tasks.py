...
def _has_database_updated_with_new_score(
    ...
    elif score.grade is None:  # submissions-related problem
...
def _update_subsection_grades(
    ...
    try:
        ...
        raise _retry_recalculate_subsection_grade(
            user_id, course_id, usage_id, only_if_higher, expected_modified_time, score_deleted, exc,
        )


def _retry_recalculate_subsection_grade(
        user_id, course_id, usage_id, only_if_higher, expected_modified_time, score_deleted, exc=None,
):
    """
